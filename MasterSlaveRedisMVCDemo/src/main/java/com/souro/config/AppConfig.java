...
public class AppConfig {
	...
	private static final RedisSentinelConfiguration SENTINEL_CONFIG = new RedisSentinelConfiguration().master("souro_master") //
			.sentinel("souro-cluster-dsbld-001.ltvsn1.0001.use2.cache.amazonaws.com", 6379) //
			.sentinel("souro-cluster-dsbld-002.ltvsn1.0001.use2.cache.amazonaws.com", 6379) //
			.sentinel("souro-cluster-dsbld-003.ltvsn1.0001.use2.cache.amazonaws.com", 6379);
