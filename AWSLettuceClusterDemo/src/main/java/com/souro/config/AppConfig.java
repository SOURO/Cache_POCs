	...
	RedisClusterConfiguration redisClusterConfiguration() {
		...
		clusterConfiguration
				.addClusterNode(new RedisNode(
						"souro-clstr-enbld.ltvsn1.clustercfg.use2.cache.amazonaws.com",
						6379));
		/*clusterConfiguration
				.addClusterNode(new RedisNode(
						"redis://souro-cluster-dsbld-002.ltvsn1.0001.use2.cache.amazonaws.com",
						6379));
		clusterConfiguration
				.addClusterNode(new RedisNode(
						"redis://souro-cluster-dsbld-003.ltvsn1.0001.use2.cache.amazonaws.com",
						6379));*/
